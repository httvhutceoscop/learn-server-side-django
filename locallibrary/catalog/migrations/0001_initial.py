# Generated by Django 3.0.4 on 2021-04-09 08:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wiki', models.URLField(blank=True, help_text='Enter a wiki url for author.', null=True, verbose_name='Wiki URL')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Enter a language (e.g. English, Tiếng Việt, 日本語)', max_length=100)),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
